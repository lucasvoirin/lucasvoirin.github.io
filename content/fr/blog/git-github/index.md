...
<img src="./hackerman.png" data-fig-align="center" />
...
1.  Une fois dans le menu de configuration, clique sur `SSH and GPG keys`.
    Puis, clique sur le bouton vert `New SSH key`.

![](github_keys.png)

1.  Tu peux alors entrer le titre de la clé dans la case `Title` (ce que tu mets n'as pas vraiment d'importance, c'est juste pour te souvenir de quel ordinateur est lié à cette clé) et copier la clé publique dans la case `Key`.

![](github_ssh.png)

1.  Cliques enfin sur `Add SSH key` et voilà, c'est fini !
